...
efficiency <- global_efficiency(graph1, weights = NULL, directed = FALSE)
## set p = 0 using same number of edges and vertices. This is the case of regular lattice.
g0 <- sample_smallworld(1, vertex_number, mean_degree, 0)
